...
OutSystems Data Grid wraps Wijmo FlexGrid v5.20261.52 to deliver enterprise-grade spreadsheet functionality in OutSystems Reactive Web applications. The repository contains TypeScript (browser-side grid wrapper) and a .NET extension (server-side data preparation).
...
- `src/@types/wijmo-5.20261.52/` -- vendored Wijmo type definitions
