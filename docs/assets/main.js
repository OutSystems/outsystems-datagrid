...
`,
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        for (var b = 0; b < d.length; b++) {
                            ...
                            this.invertedIndex[g][o][n] == null &&
                                (this.invertedIndex[g][o][n] =
                                    Object.create(null));
                            for (
                                var p = 0;
                                p < this.metadataWhitelist.length;
                                p++
                            ) {
    ...
    function Re(t, e, r, n) {
        ...
        for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
            ...
            globalThis.DEBUG_SEARCH_WEIGHTS &&
                ...
                l.parent &&
                    (u = `<span class="parent">${le(l.parent, i)}.</span>${u}`);
    ...
    function le(t, e) {
        ...
        for (; o != -1; )
            i.push(
                K(t.substring(s, o)),
                `<b>${K(t.substring(o, o + n.length))}</b>`
            ),
                (s = o + n.length),
                (o = r.indexOf(n, s));
