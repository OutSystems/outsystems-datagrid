...
namespace WijmoProvider.Feature {
        ...
        implements OSFramework.Feature.IExport, OSFramework.Interface.IBuilder
    {
        ...
        private _removeLoadingMessage() {
            const gridId = this._grid.widgetId;
            const loadingMessageElem = document.querySelector(
                '#' +
                    gridId +
                    ' .' +
        ...
        private _showLoadingMessage() {
            const gridId = this._grid.widgetId;
            const parentPlaceholder = document.querySelector(
                '#' +
                    gridId +
                    ' .' +
                    OSFramework.Helper.Constants.gridAutogeneratedPlaceholderCss
            );
