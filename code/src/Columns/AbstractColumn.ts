...
namespace Column {
    ...
    export abstract class AbstractColumn<T extends IConfigurationColumn>
        ...
        private _findParentGroup(elem: Element): string {
            ...
            if (group !== null) {
                return group
                    .firstElementChild // Consider that the GenericColumn widget is the first element on GroupColumn
        ...
        public equalsToID(id: string): boolean {
            return id === this._uniqueId || id === this.config.genericColumnId || id === this._widgetId || id === this.config.binding;
        }
