...
namespace OSFramework.DataGrid.Event.Column {
	 ...
	 */
	export class ColumnEventsManager extends AbstractEventsManager<ColumnEventType, string> {
		...
		protected getInstanceOfEventType(eventType: ColumnEventType): Event.IEvent<string> {
