...
namespace OSFramework.DataGrid.Configuration.Column {
	...
	export class ColumnConfigAction extends ColumnConfig {
		...
		constructor(config: DataGrid.Types.IColumnConfigs, extraConfig: DataGrid.Types.IActionColumnExtraConfigs) {
			super(config);
		...
		public getProviderConfig(): DataGrid.Types.IColumnProviderConfigs {
			...
			if (this.actionColumnElementType === DataGrid.Enum.CellTemplateElementType.Button)
