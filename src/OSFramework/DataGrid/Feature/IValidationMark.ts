...
namespace OSFramework.DataGrid.Feature {
	export interface IValidationMark {
		...
		setCellStatus(rowNumber: number, columnID: string, isValid: boolean, errorMessage: string): void;
		setCellStatusByKey(rowKey: string, columnWidgetID: string, isValid: boolean, errorMessage: string): void;
