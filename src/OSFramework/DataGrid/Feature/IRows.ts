...
namespace OSFramework.DataGrid.Feature {
	...
	export interface IRows {
		 ...
		 */
		addClass(rowNumber: number, className: string, refresh?: boolean, binding?: string);
		/**
		 ...
		 */
		removeClass(rowNumber: number, className: string, refresh?: boolean, binding?: string);
		/**
		 * Remove the rows by number or key.
		 */
		removeRowsByNumberOrKey(rowNumbers: Array<number>, rowKeys: Array<string>): void;
		/**
