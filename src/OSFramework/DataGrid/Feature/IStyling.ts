...
namespace OSFramework.DataGrid.Feature {
	export interface IStyling {
		 ...
		 */
		addColumnCssClass(columnID: string, className: string, includeHeader: boolean): void;
		 ...
		 * @param {string} columnID
		 */
		setColumnWordWrap(columnID: string, value: boolean, dynamicHeight: boolean): void;
	}
}
