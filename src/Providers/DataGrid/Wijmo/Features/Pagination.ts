...
namespace Providers.DataGrid.Wijmo.Feature {
			...
			OSFramework.DataGrid.Interface.IDisposable
	{
		 ...
		 * @memberof Pagination
		 */
		private _setValueInPh(label: OSFramework.DataGrid.Enum.PageLabel, phId: string): void {
		...
		public build(): void {
			...
			this._view.pageChanging.addHandler(() =>
				this._grid.features.undoStack.startAction(new PaginationAction(this._grid.provider))
			);
			this._view.pageChanged.addHandler(() => this._grid.features.undoStack.closeAction(PaginationAction));
		...
		public executeAction(action: OSFramework.DataGrid.Enum.PageAction): boolean {
			switch (action) {
		...
		public getValueByLabel(label: OSFramework.DataGrid.Enum.PageLabel): number {
			if (this._view) {
				switch (label) {
		 ...
		 * @memberof Pagination
		 */
		public registerLabel(label: OSFramework.DataGrid.Enum.PageLabel, phId: string): void {
