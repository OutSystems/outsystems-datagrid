...
namespace Providers.DataGrid.Wijmo.Feature {
	...
	export abstract class AbstractFactoryBuilder implements IFeatures, OSFramework.DataGrid.Interface.IBuilder {
	...
	export class FeatureBuilder extends AbstractFactoryBuilder {
		...
		private _makeColumnAggregate(enable: boolean): FeatureBuilder {
			this._features.columnAggregate = this._makeItem(ColumnAggregate, enable);
			return this;
		}
		...
		private _makeConditionalFormat(): FeatureBuilder {
			this._features.conditionalFormat = this._makeItem(ConditionalFormat);
			return this;
		}
		...
		private _makeSelection(allowRowSelector: boolean, selectionMode: number): FeatureBuilder {
		...
		public build(): void {
			const config = this._grid.config as OSFramework.DataGrid.Configuration.Grid.FlexGridConfig;
