...
namespace Providers.DataGrid.Wijmo.Feature {
	export class ColumnFreeze
		implements OSFramework.DataGrid.Feature.IColumnFreeze, OSFramework.DataGrid.Interface.IBuilder
	{
		...
		public bySelection(cell: OSFramework.DataGrid.OSStructure.CellRange): void {
		...
		public leftColumns(n?: number): void {
			if (n !== undefined) {
				if (n < 0) {
					throw new Error(OSFramework.DataGrid.Enum.ErrorMessages.FreezeColumnPositiveNumberExpected);
				}
