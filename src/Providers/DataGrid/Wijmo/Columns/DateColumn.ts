	...
	> {
		constructor(
			...
			super(
				grid,
				columnID,
				new OSFramework.DataGrid.Configuration.Column.ColumnConfig(configs),
				new OSFramework.DataGrid.Configuration.Column.EditorConfigDate(editorConfig, false)
			);
		...
		public changeProperty(propertyName: string, propertyValue: any): void {
			switch (propertyName) {
				case OSFramework.DataGrid.OSStructure.ColumnProperties.Format:
					this.editorConfig.format = propertyValue || this.editorConfig.defaultFormat;
					this.applyConfigs();
					break;
				default:
