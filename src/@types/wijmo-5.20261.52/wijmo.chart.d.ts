...
declare module wijmo.chart {
    class _VolumeHelper {
        ...
        convertBack(x: number, _min: number, _max: number): number;
        private _init;
        private _getXVolume;
...
declare module wijmo.chart {
    ...
    const DataLabelClsNames: {
        border: string;
        label: string;
        labels: string;
        line: string;
    };
    const FlexChartClsNames: {
        footer: string;
        header: string;
        hostElement: string;
        label: string;
    ...
    const FlexPieClsNames: {
        hostElement: string;
        slice: string;
        sliceGroup: string;
    };
    const LegendClsNames: {
        legend: string;
        title: string;
    };
    const LineMarkerClsNames: {
        container: string;
        content: string;
        draggable: string;
        hline: string;
...
declare module wijmo.chart {
    ...
    class Legend {
        ...
        _render(engine: IRenderEngine, pt: wijmo.Point, _pos: Position, w: number, h: number): void;
...
declare module wijmo.chart {
    ...
    class FlexChartBase<T = any> extends wijmo.Control implements _IPalette {
        ...
        _renderEls(engine: IRenderEngine, sz: wijmo.Size, applyElement?: boolean, bg?: string, _hidden?: boolean): void;
        private _h;
        ...
        _prepareRender(): void;
        _renderChart(_engine: IRenderEngine, _rect: wijmo.Rect, _applyElement: boolean): void;
        _performBind(): void;
        _getDesiredLegendSize(_engine: IRenderEngine, _isVertical: boolean, _width: number, _height: number): wijmo.Size;
        _renderLegend(_engine: IRenderEngine, _pt: wijmo.Point, _areas: any[], _isVertical: boolean, _width: number, _height: number): void;
        _getHitTestItem(_index: number): any;
        _getHitTestValue(_index: number, _gi?: number): any;
        _getHitTestLabel(_index: number): any;
        _refreshChart(): void;
...
declare module wijmo.chart {
    ...
    class _LinesArea implements _IHitArea {
        ...
        ignoreLabel: boolean;
        constructor(x: any, y: any);
        contains(_pt: wijmo.Point): boolean;
        distance(pt: wijmo.Point): number;
    }
    class _HitResult {
        area: _IHitArea;
...
declare module wijmo.chart {
    ...
    class SeriesBase<T = any> implements _ISeries {
        ...
        _getAltSymbolStroke(_seriesIndex?: number): string;
        _getAltSymbolFill(_seriesIndex?: number): string;
...
declare module wijmo.chart {
    ...
    class _BasePlotter {
        ...
        _getPointAndPosition(pt: wijmo.Point, _pos: LabelPosition, map: _IHitArea, chart: FlexChartCore): void;
        ...
        isValid(datax: number, datay: number, _ax: _IAxis, _ay: _IAxis): boolean;
        load(): void;
        unload(): void;
...
declare module wijmo.chart {
    ...
    class FlexPie extends FlexChartBase {
        ...
        _render(engine: IRenderEngine, applyElement?: boolean, bg?: string): void;
        _prepareRender(): void;
        _renderChart(engine: IRenderEngine, rect: wijmo.Rect, _applyElement: boolean): void;
        _layout(eng: IRenderEngine, r: wijmo.Rect, titles: string[], n: number): wijmo.Rect[];
        _getDesiredLegendSize(engine: IRenderEngine, isVertical: boolean, width: number, height: number): wijmo.Size;
        _renderLegend(engine: IRenderEngine, pos: wijmo.Point, areas: any[], isVertical: boolean, width: number, height: number): void;
        _renderData(engine: IRenderEngine, rect: wijmo.Rect, i: number, _g: any): void;
        ...
        _renderSlice(engine: IRenderEngine, cx: number, cy: number, currentAngle: number, gi: number, idx: number, radius: number, innerRadius: number, startAngle: number, sweep: number, _totalSweep: number): void;
...
declare module wijmo.chart {
    ...
    class Axis implements _IAxis {
         ...
         *
         * The default value for this property is <b>true</b> for the x-axis and is <b>false</b> for the y-axis.
         */
        axisLine: boolean;
        /**
        ...
        _isOverlapped(engine: IRenderEngine, w: number, lblClass: string, _axisType: AxisType): boolean;
        _actualAngle: number;
        /**
        ...
        _renderLabelsAndTicks(engine: any, _index: any, val: any, sval: any, labelAngle: any, tickMarks: any, showLabel: any, t1: any, t2: any): boolean;
        ...
        _createLogarithmicMinors(engine: IRenderEngine, vals: number[], isVert: boolean, isNear: boolean, _isCategory: boolean): void;
        ...
        _getMinNum(): number;
        _getMaxNum(): number;
        _getTitleSize(): wijmo.Size;
        private _invalidate;
        private _cvCollectionChanged;
        private _createLabels;
        private _createLogarithmicLabels;
        _createTimeLabels(_start: number, _len: number, vals: number[], lbls: string[]): void;
        _formatValue(val: number): string;
        _hitTest(point: wijmo.Point): any;
...
declare module wijmo.chart {
    ...
    class _AxisGroup {
        ...
        getSize(engine: IRenderEngine, className?: string, groupClass?: string): wijmo.Size;
        render(engine: IRenderEngine, axis: Axis, value: number, className?: string, groupClass?: string): void;
        hitTest(point: wijmo.Point): _AxisLabel;
...
declare module wijmo.chart {
    ...
    class _AreaPlotter extends _BasePlotter implements _IPlotter {
        ...
        private stackPos;
        private stackNeg;
        adjustLimits(dataInfo: _DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        clear(): void;
        plotSeries(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: _ISeries, palette: _IPalette, iser: number, nser: number, customRender?: (value: any) => void): void;
        private _isRange;
        private _modifyPoints;
        plotSeriesRanged(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: _ISeries, palette: _IPalette, _iser: number, _nser: number, customRender?: (value: any) => void): void;
...
declare module wijmo.chart {
    ...
    class _BarPlotter extends _BasePlotter implements _IPlotter {
        ...
        stacking: Stacking;
        rotated: boolean;
        _getSymbolOrigin: (...args: any[]) => any;
        _getSymbolStyles: (...args: any[]) => any;
        clear(): void;
        load(): void;
        unload(): void;
        adjustLimits(dataInfo: _DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        private _isRange;
        plotSeries(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: _ISeries, _palette: _IPalette, iser: number, nser: number, customRender?: (value: any) => void): void;
        private drawSymbol;
...
declare module wijmo.chart {
    ...
    class _FunnelPlotter extends _BasePlotter implements _IPlotter {
        ...
        rotated: boolean;
        adjustLimits(dataInfo: _DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        plotSeries(engine: IRenderEngine, _ax: _IAxis, _ay: _IAxis, series: _ISeries, _palette: _IPalette, _iser: number, _nser: number, _customRender?: Function): void;
        private _getTrapezoidArea;
        private _getTrapezoidOffsetY;
        private drawDefaultSymbol;
        _getPointAndPosition(pt: wijmo.Point, pos: LabelPosition, map: _IHitArea, _chart: FlexChartCore): void;
    }
...
declare module wijmo.chart {
    class _FinancePlotter extends _BasePlotter {
        ...
        adjustLimits(dataInfo: _DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        plotSeries(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: _ISeries, _palette: _IPalette, _iser: number, _nser: number, _customRender?: Function): void;
        _drawSymbol(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, si: number, pi: number, _fill: any, w: number, x: number, hi: number, lo: number, open: number, close: number, pointsLength: number): void;
    }
}
declare module wijmo.chart {
    /**
...
declare module wijmo.chart {
    ...
    class _LinePlotter extends _BasePlotter implements _IPlotter {
        ...
        clear(): void;
        adjustLimits(dataInfo: _DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        plotSeries(engine: IRenderEngine, ax: _IAxis, ay: _IAxis, series: _ISeries, _palette: _IPalette, _iser: number, _nser: number, customRender?: Function): void;
...
declare module wijmo.chart {
    class _BubblePlotter extends _LinePlotter {
        ...
        _drawSymbol(engine: IRenderEngine, x: number, y: number, _sz: number, series: Series, pointIndex: number, ifmt: Function): void;
    }
}
declare module wijmo.chart {
}
