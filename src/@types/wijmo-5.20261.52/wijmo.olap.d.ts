...
declare module wijmo.olap {
    ...
    const PivotChartClsNames: {
        hierarchicalAxesLine: string;
        hostElement: string;
    };
    const PivotFieldEditorClsNames: {
        hostElement: string;
    };
    const PivotFilterEditorClsNames: {
        hostElement: string;
    };
    const PivotGridClsNames: {
        colFieldHdr: string;
        hostElement: string;
        pivotCollapse: string;
        rowFieldHdr: string;
    };
    const PivotPanelClsNames: {
        aggregate: string;
        header: string;
        hostElement: string;
    };
    const SlicerClsNames: {
        header: string;
        hostElement: string;
        noCheck: string;
    };
    const _GridContextMenuClsNames: {
        hostElement: string;
    };
}
declare module wijmo.olap {
...
declare module wijmo.olap {
    ...
    class PivotPanel<T = any> extends wijmo.Control {
        ...
        _copy(key: string, value: any): boolean;
        _globalize(): void;
        _itemsSourceChanged(_s: PivotEngine, e?: wijmo.EventArgs): void;
        _viewDefinitionChanged(_s: PivotEngine, e?: wijmo.EventArgs): void;
        _updatingView(_s: PivotEngine, e: ProgressEventArgs): void;
        _updatedView(_s: PivotEngine, e?: wijmo.EventArgs): void;
        _requestError(_s: PivotEngine, _e: wijmo.RequestErrorEventArgs): void;
...
declare module wijmo.olap {
    ...
    class PivotGrid<T = any> extends wijmo.grid.FlexGrid {
        ...
        _formatItem(_s: any, e: wijmo.grid.FormatItemEventArgs): void;
