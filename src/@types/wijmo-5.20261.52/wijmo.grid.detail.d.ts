...
declare module wijmo.grid.detail {
    const FlexGridDetailProviderClsNames: {
        detail: string;
        detailRow: string;
        elemDetail: string;
    };
...
declare module wijmo.grid.detail {
    ...
    class FlexGridDetailProvider {
        ...
        _selectionChanged(s: wijmo.grid.FlexGrid, _e: wijmo.EventArgs): void;
        _formatItem(_s: any, e: wijmo.grid.FormatItemEventArgs): void;
        _resizedRow(_s: any, e: wijmo.grid.CellRangeEventArgs): void;
