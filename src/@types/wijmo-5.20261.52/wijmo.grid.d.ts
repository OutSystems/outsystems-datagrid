...
declare module wijmo.grid {
    const FlexGridClsNames: {
        ...
        sortDesc: string;
        sortIndex: string;
        stickyGroupCell: string;
        stickyGroupHeaders: string;
        stickyGroupRow: string;
        topLeft: string;
...
declare module wijmo.grid {
    ...
    class GridPanel {
        ...
        _getSpecialData(r: number, row: Row, c: number, col: Column, bindingCol: any, isGroupRow: boolean, group: wijmo.collections.CollectionViewGroup, originalValue: any): any;
        /**
...
declare module wijmo.grid {
    ...
    function softDetailRow(): any;
    function softMultirow(): any;
    function softTransposed(): any;
    function softTransposedMultirow(): any;
    function softSheet(): any;
    function softRestCV(): any;
    function softODataCV(): any;
    function softGridInteropBase(): any;
}
declare module wijmo.grid {
    /**
    ...
    class _SelectionHandler {
        ...
        _getNextColumnCell(_r: number, c: number, move: SelMove, pageSize?: number): any;
        _getNextRowCell(r: number, _c: number, move: SelMove, pageSize?: number): any;
...
declare module wijmo.grid {
    ...
    class Column extends RowCol {
        ...
        header: string | null;
        /**
         * Gets or sets the place holder for a column which will be displayed when editing an empty cell.
         *
         * The default value for this property is **null**, which causes
         * the grid to use the the header of the column as place holder.
         */
         ...
         *
         * The default value for this property is **null**, which causes the
         * column to be sorted in the order defined by the grid's SortOrder property.
         *
         * To override the default sort order, set this property
         * to one of the options of {@link SortOrder}
         */
        sortOrder: SortOrder;
        /**
    ...
    class RowColCollection<T extends RowCol = RowCol> extends wijmo.collections.ObservableArray<T> {
        ...
        _frozenEnd: number;
        _lastFrozen: number;
        _lastFrozenVisible: number;
        _lastUnfrozenVisible: number;
         ...
         */
        frozenEnd: number;
        _frozenInternal: number;
        /**
         * Checks whether a column or row is frozen.
         * we take into account the case this.frozen < 0.
        ...
        /**
         * get the last frozen column or row (in the case of frozen on the right/bottom,
         * the count goes from right to left or bottom to top, respectively)
         */
        readonly lastFrozen: RowCol | null;
        /**
...
declare module wijmo.grid {
    ...
    class _AddNewHandler {
        ...
        _pastingData(_s: FlexGrid, e: CellRangeEventArgs): void;
        _pastedData(_s: FlexGrid, _e: CellRangeEventArgs): void;
...
declare module wijmo.grid {
     ...
     * This interface defines the structure for specifying the number of frozen rows and columns.
     *
     ...
     */
    interface IGridFreezeOptions {
        /**
         * The number of rows to freeze at the top of the grid.
         * These rows will remain visible when scrolling vertically.
         */
        top?: number;
        /**
         * The number of rows to freeze at the bottom of the grid.
         * These rows will remain visible when scrolling vertically.
         */
        bottom?: number;
        /**
         * The number of columns to freeze on the left side of the grid.
         * These columns will remain visible when scrolling horizontally.
         */
        left?: number;
        /**
         * The number of columns to freeze on the right side of the grid.
         * These columns will remain visible when scrolling horizontally.
         */
        right?: number;
    }
     ...
     *     <tr><td>Control + X</td><td>Copy the selection to the clipboard and clear or delete any selected content that can be modified (if the {@link autoClipboard} property is set to true and the {@link preventCut} property is set to false)</td></tr>
     ...
     *     <tr><td>Control + +</td><td>When {@link allowAddNew} is true, insert a new blank row above the current active cell. (+ key on numpad)</td></tr>
     *     <tr><td>Control + -</td><td>When {@link allowDelete} is true, delete the row where the active cell is located. (- key on numpad).</td></tr>
     *     <tr><td>Control + Shift + F</td><td>Open the column filter where the active cell is located.</td></tr>
     *     <tr><td>Control + Shift + S</td><td>Sort the column where the active cell is located.</td></tr>
     *     <tr><td>Control + Shift + P</td><td>Pin/unpin the column where the active cell is located.</td></tr>
     *     <tr><td>Control + Alt + F</td><td>Freeze all rows and columns before the active cell.</td></tr>
     *   </tbody>
     * </table>
     *
    ...
    class FlexGrid<T = any> extends wijmo.Control {
        ...
        static _RESIZE_SCRL_GAP: number;
        /**
         * Gets or sets the pixel increment used when resizing rows or columns with keyboard shortcuts.
         *
         * This is a static property shared by all {@link FlexGrid} instances. You can customize it
         ...
         * value (e.g. 1) provides finer-grained control.
         *
         * The value should be a positive integer. Decimal values (e.g. 0.5) will be rounded to
         * the nearest integer.
         *
         * This property defines the amount (in pixels) by which row height or column width changes
         * when using the following keyboard shortcuts:
         ...
         *
         * This feature was added to meet WCAG 2.2 AA Success Criteria 2.5.7 (Dragging Movements),
         * ensuring that all dragging operations have keyboard alternatives.
         *
         * The default value is 2.
         */
        static SHORTCUT_KEY_RESIZE_GAP: number;
        static _MAX_FROZEN_GAP_LIMIT: number;
        static _FLEXGRID_COUNT: number;
        ...
        protected _sortOrder: SortOrder;
        ...
        protected _stickyGrpHdr: boolean;
        private _eStickyGroups;
        private _eStickyGroupRowHeaders;
        private _stickyGroupPath;
        private _stickyGroupTransitionAnchor;
        private _stickyGroupReveal;
        private _stickyGroupScrollY;
        private _stickyGroupKeyboardArrowUp;
        ...
        protected _noDataOverlayContent: string;
        ...
        /**
         * Gets or sets a value that determines whether row group headers should remain
         * visible when the user scrolls the flexgrid.
         *
         * This feature is not supported together with frozen rows or columns.
         * Keep {@link frozenRows}, {@link frozenColumns}, and {@link frozenCells}
         * disabled when using sticky group headers.
         *
         * The default value for this property is **false**.
         */
        ...
        allowDelete: boolean;
        /**
         * Gets or sets a value that determines whether the grid disables its
         * built-in handling for the standard clipboard cut shortcut key.
         *
         * When this property is set to true, the grid will not copy, clear,
         ...
         * event listeners may continue to handle it.
         *
         * This value is a boolean value; you need to pass in a boolean value. The default value for this property is **false**.
         */
        preventCut: boolean;
        /**
         ...
         *
         * Frozen panes are not supported together with {@link stickyGroupHeaders}.
         *
         */
         ...
         */
        getCellData(r: number, c: number | string, formatted: boolean): any;
        getRowDataItem(r: number, _c: number): any;
        _getRowData(r: number): any;
        /**
        ...
        treeIndent: number;
        /**
         * Gets or sets the index of the column that displays the tree outline
         * (expand/collapse buttons and indentation) in Treegrid.
         *
         * By default (value = -1), the tree outline is shown in the first visible column.
         * Set this property to display the tree outline in a specific column.
         *
         * Example:
         * <pre>
         ...
         * </pre>
         *
         * The default value for this property is **-1** (first visible column).
         * This API only works in TreeGrid, not in Group.
         */
        treeColumnIndex: number;
        _getTreeColIndex(): number;
        ...
        _cvCollectionChanged(_sender: any, e: wijmo.collections.NotifyCollectionChangedEventArgs): void;
        ...
        private _shouldShowStickyGroupHeaders;
        private _createStickyGroupOverlayElement;
        private _ensureStickyGroupOverlay;
        private _ensureStickyGroupRowHeaderOverlay;
        private _disposeStickyGroupContainerContent;
        private _ensureStickyGroupOverlaySlot;
        private _trimStickyGroupOverlaySlots;
        private _clearStickyGroupOverlay;
        private _hideStickyGroupOverlay;
        private _resetStickyGroupState;
        private _resetStickyGroupRevealTransition;
        private _getStickyGroupBaseTop;
        private _getStickyGroupBaseNaturalTop;
        private _getStickyGroupViewportWidth;
        private _getStickyGroupViewportHeight;
        private _getStickyGroupSlotNaturalTop;
        private _findStickyGroupBranchEnd;
        private _findStickyGroupSlotRow;
        private _collectStickyGroupPath;
        private _isStickyGroupPathPrefix;
        private _getStickyGroupSharedPrefixLength;
        private _isSameStickyGroupPath;
        private _findVisibleGroupRow;
        private _findLastVisibleGroupRowInBranch;
        private _getStickyGroupDriverTop;
        private _getStickyGroupCellGeometry;
        private _getStickyGroupBottomSlotTop;
        private _findStickyGroupDriverRow;
        private _useLiveStickyGroupPath;
        private _getStickyGroupIncomingPathAbove;
        private _armStickyGroupRevealTransition;
        private _continueStickyGroupRevealTransition;
        private _resolveStickyGroupPathWhileScrollingUp;
        private _trimReleasedStickyGroupRows;
        private _tryStartStickyGroupTransition;
        private _continueStickyGroupTransition;
        private _createStickyGroupPathResolution;
        private _resolveStickyGroupPath;
        private _buildStickyGroupSlots;
        private _applyStickyGroupReveal;
        private _getStickyGroupOverlayBottom;
        private _getStickyGroupPathBottom;
        private _getStickyGroupKeyboardRevealBottom;
        _setStickyGroupKeyboardArrowUp(value: boolean): void;
        private _scrollIntoViewStickyGroupBoundary;
        private _applyStickyGroupPushOff;
        private _updateStickyGroupOverlayBounds;
        private _renderStickyGroupCell;
        private _renderStickyGroupCellForColumn;
        private _renderStickyGroupPanelCells;
        private _createStickyGroupSlotRow;
        private _renderStickyGroupOverlaySlot;
        private _updateStickyGroupHeaders;
        private _resolveStickyGroupSlots;
        private _createStickyGroupOverlayLayout;
        private _prepareStickyGroupOverlays;
        private _renderStickyGroupOverlays;
        _hitStickyGroupCell(pt: wijmo.Point): {
            cell: HTMLElement;
            row: number;
            col: number;
            panel: GridPanel;
        ...
        _getBindingColumn(_p: GridPanel, _r: Number, c: Column): Column;
        ...
        _allowKeyboardDragging(): boolean;
        ...
        _isServerCollectionView(_cv: any, grid?: FlexGrid): boolean;
...
declare module wijmo.grid {
    function toggleColumnPinning(grid: FlexGrid, col: number, row: number, isColumnRangePin: boolean, isShiftKey?: boolean): void;
    function toggleColumnSort(grid: FlexGrid, panel: GridPanel, column: number, row: number, e: MouseEvent | KeyboardEvent, ctrlKey?: boolean, shiftKey?: boolean): void;
}
declare module wijmo.grid {
    /**
    ...
    class CellFactory {
        ...
        _interopDisposeCell(_cell: HTMLElement): void;
        /**
    ...
    function isNullOrEmptyString(content: any): boolean;
}
declare module wijmo.grid {
    /**
    ...
    class _CustomEditor {
        ...
        private _imeEditInput;
        private _imeEditInputState;
        private _imeCompositionFinalizeTimer;
        private _imeEditInputCleanup;
        private _imeCompositionHandOffCleanup;
        private _displayMonthChangingHandler;
        private _displayMonthChangedHandler;
        private _savedGridWidth;
        private _isDroppedDownChangingHandler;
        private _isDroppedDownChangedHandler;
        private static readonly _IME_COMPOSITION_SETTLE_DELAY;
        /**
        ...
        private _handoffImeCompositionOnAutoCompleteDropDownKey;
        private _isAutoCompleteDropDownNavigationKey;
        private _mousedown;
        ...
        private _matchesColumn;
        private _onHostBlur;
        private _cancelImeCompositionFinalize;
        private _cancelImeCompositionHandOff;
        private _scheduleImeCompositionFinalize;
        private _setEditorInputValue;
        private _dispatchEditorInput;
        private _clearImeEditInputState;
        private _finalizeImeEditInputValue;
        private _initImeEditInput;
        private _createImeEditInputState;
        private _attachImeEditInput;
        private _syncImeEditInput;
        private _detachImeEditInput;
        private _restoreImeEditInputOwner;
        private _finalizeImeComposition;
        private _onImeEditInputGotFocus;
        private _applyImeEditInputValue;
        private static _setSelectionRange;
        private _imeEditor;
        private _ensureEditorsContainer;
        private _restoreTbxValue;
        private _getCellValue;
        private _parseCheckedItems;
    }
}
declare module wijmo.grid {
    const colHdrAriaAttributes: (cell: HTMLElement, col: Column, gridPanel: GridPanel, g: FlexGrid<any>, content: string, isRowHeader?: boolean) => void;
}
declare module wijmo.grid {
    class _ResizeHelper {
        static getPanelForColumn(grid: FlexGrid, col: Column): GridPanel;
        static getPanelForRow(grid: FlexGrid, row: Row): GridPanel;
        static createResizingArgs(panel: GridPanel, rowCol: Row | Column, newSize: number, isColumn: boolean, isPrimaryDragged?: boolean): CellRangeEventArgs;
        static applyMaxSizeConstraint(newSize: number, args: CellRangeEventArgs): number;
        static triggerResizingEvent(grid: FlexGrid, rowCol: Row | Column, newSize: number, isColumn: boolean, isPrimaryDragged?: boolean, reuseArgs?: CellRangeEventArgs): {
            finalSize: number;
            args: CellRangeEventArgs;
        } | null;
        static showResizeMarker(grid: FlexGrid, rowCol: RowCol, size: number, panelType: CellType): void;
        static showResizeMarkerInternal(grid: FlexGrid, marker: HTMLElement, rowCol: RowCol, size: number, panelType: CellType): void;
    }
}
declare module wijmo.grid {
    /**
    ...
    class HitTestInfo {
         ...
         */
        correctionForNegativeFrozen(position: wijmo.Point): void;
...
declare module wijmo.grid {
    ...
    class _EditHandler {
        ...
        _deferPaste(_rng: CellRange, cnt: number): boolean;
...
declare module wijmo.grid {
    ...
    class _MouseHandler {
        ...
        private _isNearLeftFrozenEdge;
        private _isNearTopFrozenEdge;
        private _getRightFrozenWidth;
        private _isNearRightFrozenEdge;
        private _getBottomFrozenHeight;
        private _isNearBottomFrozenEdge;
        private _isNearFrozenEdge;
        private _hasLeftHiddenContent;
        private _hasRightHiddenContent;
        private _hasTopHiddenContent;
        private _hasBottomHiddenContent;
        private _clampHitTestForFrozenScroll;
        private _getFrozenColSide;
        private _getFrozenRowSide;
        private _isMouseOutsideGrid;
        private _isMouseInHeaderArea;
        private _isFrozenScrollHeaderSelection;
        private _isDraggingFromFrozenColWithHiddenContent;
        private _isDraggingFromFrozenRowWithHiddenContent;
        private _isDraggingFromFrozenWithHiddenContent;
        private _hasSelectionSpannedFrozenColBoundary;
        private _hasSelectionSpannedFrozenRowBoundary;
        private _getBorderWidthFromHitTest;
        private _findFirstVisibleColumnAtScroll;
        private _findPreviousVisibleColumn;
        private _findColumnToScrollLeft;
        private _findColumnToScrollRight;
        private _handleLeftFrozenScroll;
        private _findLastVisibleColumnAtScroll;
        private _findNextVisibleColumn;
        private _handleRightFrozenScroll;
        private _handleFrozenColumnScroll;
        private _handleFrozenToNonFrozenColumnScroll;
        private _findFirstVisibleRowAtScroll;
        private _findPreviousVisibleRow;
        private _findRowToScrollUp;
        private _findRowToScrollDown;
        private _handleTopFrozenScroll;
        private _findLastVisibleRowAtScroll;
        private _findNextVisibleRow;
        private _handleBottomFrozenScroll;
        private _handleFrozenRowScroll;
        private _handleFrozenToNonFrozenRowScroll;
        private _getFrozenScrollRefreshTarget;
        private _refreshSelectionAfterFrozenScroll;
...
declare module wijmo.grid {
    ...
    class _KeyboardHandler {
        ...
        private _handleDraggingByKeyboard;
        private _isDetailRow;
        private _adjustTargetForDetailRow;
        private _fireDragAndMove;
        private _isAwaitingResizeConfirmation;
        private _handleDeferredResizeKeys;
        private _checkAndCleanupResizingState;
        private _initializeResizingState;
        private _applyResize;
        private _handleResizingByKeyboard;
        private _applyConfirmedResize;
        private _confirmResizingByKeyboard;
        private _cancelResizingByKeyboard;
        private _showResizeMarker;
        private _cleanupResizingState;
        private _removeResizeMarker;
        dispose(): void;
    }
}
declare module wijmo.grid {
