...
declare module wijmo.input {
    const AutoCompleteClsNames: {
        hostElement: string;
    };
    const CalendarClsNames: {
    ...
    const CollectionViewNavigatorClsNames: {
        hostElement: string;
        pager: string;
    };
    const ColorPickerClsNames: {
        colorBox: string;
        hostElement: string;
    };
    const ComboBoxClsNames: {
        hostElement: string;
        stateMatch: string;
    };
    const DropDownClsNames: {
    ...
    const InputNumberClsNames: {
        hostElement: string;
        numeric: string;
        showSpinner: string;
    };
    const InputTimeClsNames: {
        hostElement: string;
    };
    const ListBoxClsNames: {
        header: string;
        hostElement: string;
        listBoxItem: string;
    };
    ...
    const MultiAutoCompleteClsNames: {
        hostElement: string;
        token: string;
        tokenActive: string;
        tokenClose: string;
    ...
    const MultiSelectListBoxClsNames: {
        header: string;
        hostElement: string;
        selectAll: string;
    };
...
declare module wijmo.input {
    ...
    class InputNumber extends wijmo.Control {
        ...
        format: string;
        /**
         * Gets or sets whether the control truncates numeric values that exceed
         * the decimal precision defined by {@link format}, instead of applying rounding.
         *
         * For example, if {@link format} = 'n2' and the value is 99.999,
         * setting {@link truncate} to true will store 99.99 rather than rounding to 100.
         *
         * Default is **false**, which preserves the standard rounding behavior.
         */
        truncate: boolean;
        /**
...
declare module wijmo.input {
    ...
    class ListBox<T = any> extends wijmo.Control {
        ...
        _createHeaderItem(group: wijmo.collections.CollectionViewGroup, groupIndex: number): string;
        private _click;
        private _keydown;
...
declare module wijmo.input {
    ...
    class Calendar extends wijmo.Control {
        ...
        private _showYearListBoxButton;
        private _focusMode;
        private _focusValue;
        private _keyActionTab;
        private _ariaLabel;
        ...
        private _fmtDay;
        private _fmtMonths;
        private _fmtDayTitle;
        static _DATE_KEY: string;
        static _ctrlTemplate: string;
        _sholudPreventFocusScroll: boolean;
        /**
        ...
        readonly displayMonthChanging: Event<Calendar, EventArgs>;
        onDisplayMonthChanging(e?: wijmo.EventArgs): void;
        /**
        ...
        private _updateFocusInAccessibilityMode;
        private _updateCellFocus;
        private _addWeek;
        ...
        private _navigate;
        _setTabOrder(value: number): void;
        private _showYearPickerAction;
        /**
         * Gets or sets the focusMode enabled to support wcag related functions  of {@link Calendar} element.
         */
        focusMode: boolean;
        /**
         * Gets or sets the action to perform when the Tab key is pressed.
         *
         * The default setting for this property is {@link CalendarTabKeyAction.None},
         * This means that pressing the tab key will have no effect and follow the browser's default behavior.
         */
        ...
        cancelButtonClick(e?: wijmo.EventArgs): void;
        oneCancelButtonClick(e: any): void;
        readonly OKButtonClicked: Event<Calendar, EventArgs>;
        OKButtonClick(e?: wijmo.EventArgs): void;
        onOkButtonClick(e: any): void;
        /**
         * Gets or sets the aria-label attribute of {@link Calendar} element.
         */
        ariaLabel: string;
        private _updateButtonTabIndex;
...
declare module wijmo.input {
    ...
    /**
     * Defines the behavior when keys are pressed in the control.
     */
    enum KeyAction {
        /** Changes the selection without opening the dropdown. */
        ChangeSelectionOnly = 0,
    ...
    class DropDown extends wijmo.Control {
        ...
        static _ctrlTemplate: string;
        _touchMove: boolean;
        _dropdownCausedScrollbar: boolean;
        /**
        ...
        protected _isDropdownOpened: boolean;
        /**
        ...
        _toggleDropDown(isDroppedDown: boolean): void;
        /**
         ...
         *
         * The default setting for this property is {@link KeyAction.ChangeSelectionOnly},
         * which causes the control to change the selection item while keeping the listbox closed.
         *
         * Alternatively, you can set this to {@link KeyAction.OpenDropdown} to open the listbox
         * without changing the current selection.
         */
        keyActionDownArrow: KeyAction;
        /**
        ...
        protected _keypress(e: KeyboardEvent): void;
        protected _input(_e: wijmo.Event): void;
...
declare module wijmo.input {
    ...
    class Popup extends wijmo.Control {
        ...
        constructor(element: any, options?: any);
        /**
         * Gets or sets the aria-labelledby attribute of {@link Popup} input element.
         */
        ariaLabelledBy: string;
        /**
...
declare module wijmo.input {
    /**
     * Provides arguments for {@link InputDate}'s invalidInput event.
     */
    class InputDateEventArgs extends wijmo.CancelEventArgs {
        _isUserInput: boolean;
        /**
         * Initializes a new instance of the {@link InputDateEventArgs} class.
         *
         * @param isUserInput boolean value to distinguish user input from value set in code
         */
        constructor(isUserInput: boolean);
        /**
         * Gets a value that determines whether invalid value was
         * provided by user or set in code
         */
    ...
    class InputDate extends DropDown {
         ...
         *
         * This property is used only when invalid text is set through
         * {@link text} property in code and does not affect the behavior
         * when invalid value is set by the end user
         *
         * The default value for this property is false.
         */
        ...
        inputType: string;
        /**
         * Gets or sets a value that determines whether to preserve the month
         * when user navigates to a different month than the selected date.
         *
         * The default value for this property is **true**.
         */
        ...
        protected _reselectText(specialChars: string[], currentPos: number): void;
        _refreshText(): void;
        ...
        /**
         * Gets or sets whether to display the confirmation buttons in Calendar.
         * When this property is set to true, using the arrow keys will only change the focus.
         * And "OK" and "Cancel" buttons will be displayed below the dropdown.
         */
        showConfirmationButtons: boolean;
        /**
         * Gets or sets the aria-labelledby attribute of input element.
...
declare module wijmo.input {
    ...
    class InputDateRange extends InputDate {
        ...
        protected _inputAriaLabel: any;
        /**
         * Gets or sets the template used to instantiate {@link InputDateRange} control.
         */
        static controlTemplate: string;
        /**
...
declare module wijmo.input {
    ...
    class ComboBox<T = any> extends DropDown {
        ...
        _ariaLabelledby: string;
        /**
         * Gets or sets the template used to instantiate {@link ComboBox} control.
         */
        static controlTemplate: string;
        /**
         ...
         *
         * The default setting for this property is {@link KeyAction.OpenDropdown},
         * which opens the listbox and filters options as the user types.
         * This allows users to see matching options before making a selection.
         *
         * Alternatively, you can set this to {@link KeyAction.ChangeSelectionOnly}
         ...
         */
        ariaLabelledBy: string;
        _updateInputAndListBoxAriaLabel(): void;
        /**
        ...
        tryToFindSelectIndexByText(text: string): number;
        /**
        ...
        onSelectedIndexChanged(e?: wijmo.EventArgs): void;
        refresh(fullUpdate?: boolean): void;
        onLostFocus(e?: wijmo.EventArgs, oldIdxAutoComplete?: number, forceAutoCompleteBlurIdxUpdate?: boolean): void;
        onIsDroppedDownChanging(e: wijmo.CancelEventArgs): boolean;
        onIsDroppedDownChanged(e?: wijmo.EventArgs): void;
        ...
        protected _dropDownClick(e: MouseEvent): void;
        protected _setText(text: string, fullMatch: boolean, isDateTime?: boolean): void;
        ...
        _updateComponentText(e?: wijmo.Event): void;
        private _getInputTextForUpdate;
        private _shouldUseCurrentTextAfterComposition;
        _updateEmptyValueFlag(): void;
        _controlDropdownVisibility(): void;
...
declare module wijmo.input {
    ...
    class Menu extends ComboBox {
        ...
        ariaLabel: string;
        /**
         * Gets or sets a value that determines whether the first enabled item is automatically focused/selected in the {@link dropDown}.
         * Used to add provide appropriate navigation when accessibility tools are used.
         *
         * The default value for this property is false.
         */
...
declare module wijmo.input {
    ...
    class InputTime extends ComboBox {
        ...
        _inputElementAriaLabel: string;
        /**
         * Gets or sets the template used to instantiate {@link InputTime} control.
         */
        static controlTemplate: string;
        /**
        ...
        protected _getText(): string;
        protected _canChangeValue(): boolean;
        protected getSeconds(val: Date): number;
        protected _keydown(e: KeyboardEvent): void;
...
declare module wijmo.input {
    ...
    /**
     * Represents a custom filter function used by {@link AutoComplete} and {@link MultiSelectListBox}.
     *
     * @param item The data item to test.
     * @param query The current search query string.
     * @param text The display text (after displayMemberPath processing).
     * @returns **true** to include the item in the filtered results, **false** to exclude it.
     */
    type CustomFilterCallback = (item: any, query: string, text: string) => boolean;
    /**
     * Represents a custom highlight function used by {@link AutoComplete}.
     *
     * @param item The data item being displayed.
     * @param query The current search query string.
     * @param text The display text (after displayMemberPath processing).
     * @returns An HTML string with highlighted portions wrapped in highlight spans.
     *
     * **Security Note**: Escape user input with {@link escapeHtml} to prevent XSS attacks.
     */
    type CustomHighlightCallback = (item: any, query: string, text: string) => string;
    /**
    ...
    class AutoComplete extends ComboBox {
        ...
        private _beginsWith;
        private _delay;
        private _searchDuringComposition;
        private _customFilter;
        private _customHighlight;
        _selItems: any;
        private _toSearch;
        private _query;
        private _rxSrch;
        ...
        _pendingSearchFn: any;
        static _ctrlTemplate: string;
        _inputElementAriaLabel: string;
        /**
         * Gets or sets the template used to instantiate {@link AutoComplete} control.
         */
        static controlTemplate: string;
        /**
        ...
        delay: number;
        /**
         * Gets or sets whether AutoComplete should search while IME composition is active.
         *
         * The default value for this property is **false**.
         *
         * When set to **false**, search timing stays unchanged and filtering starts
         * only after the composition is committed.
         *
         * When set to **true**, the control may filter immediately from the current
         * composing text while composition is still active.
         */
        searchDuringComposition: boolean;
        /**
        ...
        cssMatch: string;
        /**
         * Gets or sets a custom filter function for filtering items.
         *
         * When set, this function is used instead of the default filtering logic.
         * The function receives the item, the current query string, and the display text,
         * and should return true to include the item or false to exclude it.
         *
         * Set to null to restore default filtering behavior.
         *
         * @remarks
         * When customFilter is set, these properties are ignored:
         * - {@link caseSensitiveSearch}, {@link beginsWithSearch}, {@link isContentHtml}
         *
         * These properties are still honored:
         * - {@link maxItems}, {@link minLength}
         */
        customFilter: CustomFilterCallback;
        /**
         * Gets or sets a custom highlight function for highlighting matched text.
         *
         * When set, this function is called for each filtered item to generate
         * the HTML to display in the drop-down list. The function receives the
         * item, query, and display text, and should return HTML with highlighted
         * portions wrapped in &lt;span class="wj-state-match"&gt;.
         *
         * Set to null to restore default highlighting behavior.
         *
         * @remarks
         * **Security**: Always use {@link escapeHtml} on user content to prevent XSS.
         *
         * The highlight function is called before formatItem event handlers,
         * allowing handlers to override the result.
         *
         * If the function throws an exception, the error is logged and the
         * original text is displayed without highlighting.
         */
        customHighlight: CustomHighlightCallback;
        /**
         * Raises the {@link selectedIndexChanged} event.
         */
        onSelectedIndexChanged(e?: wijmo.EventArgs): void;
         ...
         */
        selectAll(): void;
        private _canSearchWhileComposing;
        private _hasExternalCompositionFocus;
        private _isLegacyImeGuardBrowser;
...
declare module wijmo.input {
    ...
    class MultiSelectListBox<T = any> extends wijmo.Control {
        ...
        _delay: number;
        _toSearch: any;
        _customFilter: CustomFilterCallback;
         ...
         * Gets or sets a custom filter function for filtering items.
         *
         * When set, this function is used instead of the default regex-based filtering.
         *
         * @param item The data item to test.
         ...
         *
         * Setting to null restores default filtering. Requires {@link showFilterInput} to be true.
         */
        customFilter: CustomFilterCallback;
        /**
        ...
        dispose(): void;
        _applyFilter(): void;
        protected _getItemText(item: any, binding?: wijmo.Binding): string;
...
declare module wijmo.input {
    ...
    class MultiSelect extends ComboBox {
        ...
        _inputElementAriaLabel: string;
        /**
         * Gets or sets the template used to instantiate {@link MultiSelect} control.
         */
        static controlTemplate: string;
        /**
         ...
         *
         * When set, this function is used instead of the default regex-based filtering
         * in the filter input. Requires {@link showFilterInput} to be true.
         *
         * @param item The data item to test.
         * @param query The current filter text.
         * @param text The display text (after displayMemberPath processing).
         * @returns **true** to include the item, **false** to exclude it.
         *
         * Setting to null restores default filtering.
         */
        customFilter: CustomFilterCallback;
        /**
         * Gets or sets the string to be used as a label for the "Select All"
