...
declare module wijmo.nav {
    ...
    const TreeViewClsNames: {
        dragFeedback: string;
        dragItemCount: string;
        hostElement: string;
...
declare module wijmo.nav {
    ...
    class TreeNode {
        ...
        /**
         * Gets a value that determines whether this node is selected or not.
         */
        readonly isSelected: boolean;
        /**
         * Selects this node.
         * @param isSilent, whether to fire selected node change event or not
         */
        select(isSilent?: boolean): void;
        /**
         * Deselects this node
         * @param isSilent, whether to fire selected node change event or not
         */
        deSelect(isSilent?: boolean): void;
        /**
...
declare module wijmo.nav {
    ...
    class TreeView extends wijmo.Control {
        ...
        private _items;
        _selNode: TreeNode;
        _selNodes: wijmo.collections.ObservableArray<TreeNode>;
        ...
        /**
         * Gets or sets a value that determines whether the TreeView should preserve selected node when
         * node list is expanded/collapsed by clicking on the expand/collapse icon.
         *
         * The default value for this property is **false**.
         */
        preserveSelectedNode: boolean;
        /**
         * Gets an array with list of currently selected nodes
         * This property works only if {@link allowMultiSelect} is set to true
         */
        readonly selectedNodes: wijmo.collections.ObservableArray<TreeNode>;
        /**
         * Gets or sets a value that determines whether multiple nodes selection is allowed or not
         * when clicking in combination with ctrl or shift key
         * The default value for this property is **false**.
         */
         ...
         * If {@link allowMultiSelect} is set to true, then this event also fires when selected nodes changes.
         */
        ...
        private _getCollapseIconWidthBounds;
        private _mousedown;
        private _getNodesBetween;
        private _getOffsetFromRoot;
        private _checkCollapseIconClick;
        private _click;
        private _keydown;
        private _keypress;
        private _findNext;
