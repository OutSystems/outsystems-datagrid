...
declare module wijmo.barcode.specialized {
    class ECC000_140 {
        ...
        calculateTotalBits(_scheme: any, headerBits: any, dataBits: any): any;
...
declare module wijmo.barcode.specialized {
    class ECC200 {
        ...
        generateFileIdentifier(_structureCount: any, fileInfo: any): number;
...
declare module wijmo.barcode.specialized {
    ...
    class Code49 extends wijmo.barcode.BarcodeBase {
        ...
        /**
         * Gets or sets the template used to instantiate {@link Code49} control.
         */
    ...
    class Code93 extends wijmo.barcode.BarcodeBase implements wijmo.barcode.IVariableWidthBarcode {
        ...
        static _ctrlTemplate: string;
        /**
         * Gets or sets the template used to instantiate {@link Code93} controls.
         */
        static controlTemplate: string;
        /**
    ...
    class Interleaved2of5 extends wijmo.barcode.BarcodeBase implements wijmo.barcode.IVariableWidthBarcode {
        ...
        static _ctrlTemplate: string;
        /**
         * Gets or sets the template used to instantiate {@link Interleaved2of5} controls.
         */
        static controlTemplate: string;
        /**
