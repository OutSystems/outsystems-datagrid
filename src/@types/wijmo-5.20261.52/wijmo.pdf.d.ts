...
declare type _PdfKitColor = string | [number, number, number] | [number, number, number, number] | _IPdfKitGradient;
...
declare type _PdfKitStructureType = 'Document' | 'Part' | 'Art' | 'Sect' | 'Div' | 'BlockQuote' | 'Caption' | 'TOC' | 'TOCI' | 'Index' | 'NonStruct' | 'Private' | 'H' | 'H1' | 'H2' | 'H3' | 'H4' | 'H5' | 'H6' | 'P' | 'L' | 'LI' | 'Lbl' | 'LBody' | 'Table' | 'TR' | 'TH' | 'TD' | 'THead' | 'TBody' | 'TFoot' | 'Span' | 'Quote' | 'Note' | 'Reference' | 'BibEntry' | 'Code' | 'Link' | 'Annot' | 'Ruby' | 'RB' | 'RT' | 'RP' | 'Warichu' | 'WT' | 'WP' | 'Figure' | 'Formula' | 'Form';
...
declare module wijmo.pdf {
    ...
    class PdfBrush {
        ...
        _getBrushObject(_area: PdfPageArea): any;
    }
}
declare module wijmo.pdf {
    /**
...
declare module wijmo.pdf {
    ...
    class PdfSolidBrush extends PdfBrush {
        ...
        _getBrushObject(_area: PdfPageArea): wijmo.Color;
    }
}
declare module wijmo.pdf {
    /**
...
declare module wijmo.pdf {
    ...
    class _SvgElementBase {
        ...
        constructor(ctx: _ISvgRenderContext, _node: SVGElement, defRenderMode?: _SvgRenderMode);
...
declare module wijmo.pdf {
    ...
    class _SvgStrokeAttributes {
        ...
        width: _SvgNumAttr;
        constructor(owner: _SvgElementBase);
        toPen(_element?: _SvgElementBase): PdfPen;
    }
