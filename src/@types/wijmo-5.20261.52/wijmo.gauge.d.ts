...
declare module wijmo.gauge {
    ...
    const LinearGaugeClsNames: {
        hostElement: string;
    };
    const RadialGaugeClsNames: {
        hostElement: string;
    };
    const RangeClsNames: {
        ranges: string;
...
declare module wijmo.gauge {
    ...
    class Gauge extends wijmo.Control {
        ...
        protected _updateRangeElement(_e: SVGPathElement, _rng: Range, _value: number): void;
        protected _updateText(): void;
        protected _updateTicks(): void;
        protected _getValueFromPoint(_pt: wijmo.Point): any;
...
declare module wijmo.gauge {
    ...
    class RadialGauge extends Gauge {
         ...
         * ```
         */
        static createNeedleElement(points: any[], capRadius?: number, innerCapRadius?: number): SVGGElement;
        /**
         * Refreshes the control.
         *
         * @param fullUpdate Indicates whether to update the control layout as well as the content.
