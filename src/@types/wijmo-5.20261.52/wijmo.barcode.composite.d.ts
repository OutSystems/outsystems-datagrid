...
declare module wijmo.barcode.composite {
    function encode928(bitString: any, codeWords: any, bitLng: any): number;
}
declare module wijmo.barcode.composite {
...
declare module wijmo.barcode.composite {
    ...
    function getIndicator(rowIndex: any, rowCount: any, ecl: any, col: any, isRight?: any): number;
    function getPattern_PDF417(row: any, value: any): number;
    function getTCValue(char: any, mode: any): number;
...
declare module wijmo.barcode.composite {
    abstract class GS1DataBarBase extends wijmo.barcode.OneDimensionalBarcode {
        ...
        static combins(n: any, r: any): number;
        ...
        getLinkageOffset(_data: any, _linkageWidth: any): void;
        getLinkageSepPattern(_data?: any): void;
