...
declare module wijmo.grid.transposed {
     ...
     * {@link FlexGridFilter}, {@link Selector}.
     */
    class TransposedGrid<T = any> extends wijmo.grid.FlexGrid {
        ...
        /**
         * Gets or sets the template used to instantiate {@link TransposedGrid} control.
         */
        ...
        _sourceViewChanged(_sender: wijmo.collections.ICollectionView, _e: wijmo.collections.NotifyCollectionChangedEventArgs): void;
