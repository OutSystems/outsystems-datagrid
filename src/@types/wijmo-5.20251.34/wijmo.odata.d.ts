...
declare module wijmo.odata {
    interface IGroupAggregate {
        binding: string;
        aggregate: wijmo.Aggregate;
        alias: string;
    }
    enum AggregatesServer {
        sum = 1,
        countdistinct = 2,
        average = 3,
        max = 4,
     ...
     *
     * **Note** : grouping function can also be performed on server but only when OData version
     *  should be NET Core 7.0 or later. As OData added [aggregation support](https://devblogs.microsoft.com/odata/aggregation-extensions-in-odata-asp-net-core/)
     * from OData 7.0.
     *
     * Refer to example {@sample Grid/Data-binding/ODataServerGroup/purejs} that loads
     *  grouped data from server and shows in {@link FlexGrid}.
     *
    ...
    class ODataCollectionView extends wijmo.collections.CollectionView {
         ...
         * This property should be set to true only when OData API support aggregation using <a href="https://learn.microsoft.com/en-us/odata/webapi-8/fundamentals/query-options?tabs=net60#apply-query">Apply query</a>.
         *
        ...
        _aggregates: string;
        _aggQuery: string;
        _iaq: IGroupAggregate[];
        /**
        * Gets or Sets the aggregates query which would parsed by the OData API and returns the aggregates as result.
        *
        * This property should be set when {@link groupOnServer} is set to true with groupDescriptions.
        *
        * Aggregates query should be in OData specified <a href="https://docs.oasis-open.org/odata/odata-data-aggregation-ext/v4.0/cs03/odata-data-aggregation-ext-v4.0-cs03.html#AggregationMethods">AggregationMethods</a> format
        *
        * ```typescript
        ...
        */
        aggregates: string;
        private _updateAggQuery;
        /**
         * Returns server-calculated aggregate value for a specified property and {@link CollectionViewGroup}.
         *
         * The {@link aggregates} property should be defined to get the server-calculated aggregate. If aggregates property is not defined, it will return empty value ''.
         *
         * @param columnBinding Name of the property to aggregate on.
         ...
         * @param aggregate The type of {@link Aggregate} to compute, that should also be defined for specified `columnBinding` in {@link aggregates}
         ...
         * With groupLazyLoading, Gets the total number of available top-level groups count.
         */
        ...
        _getReadParams(nextLink?: string, grpDef?: wijmo.collections.CollectionViewGroup | boolean): any;
        protected _getFilterDefintion(item?: wijmo.collections.CollectionViewGroup): string;
        protected _getAggregateParams(item?: wijmo.collections.CollectionViewGroup, nextLink?: string): any;
        private _getGroupItems;
        private _getItems;
        private _currentGroupRequests;
        private _currentRequests;
        protected _grpItems: any[];
        protected _grpItemCount: number;
        _getData(nextLink?: string, grpDef?: wijmo.collections.CollectionViewGroup | boolean, xhrCallback?: Function): void;
        ...
        private _saa;
        private _req;
        private _getODataAggCompatiability;
        private _getSchema;
...
declare module wijmo.odata {
     ...
     *
     * // update data window when the grid scrolls (not require from 2024v2-HF version)
     ...
     *
     *
     *  Grouping function can also be performed on server but only when OData version
     *  should be NET Core 7.0 or later. As OData added [aggregation support](https://devblogs.microsoft.com/odata/aggregation-extensions-in-odata-asp-net-core/)
     * from OData 7.0.
     *
     * Refer to example {@sample Grid/Data-binding/VirtualODataServerGroup/purejs} that loads
     *  grouped data from server virtually and shows in {@link FlexGrid}.
     */
    class ODataVirtualCollectionView extends ODataCollectionView {
         ...
         */
        constructor(url: string, tableName: string, options?: any);
        private _groupLazyLoading;
        /**
         * @deprecated
         * GroupLazyLoading is not supported in ODataVirtualCollectionView
         */
        groupLazyLoading: boolean;
        /**
        * @deprecated
        * lazyLoadGroup() is not supported as  GroupLazyLoading is not supported in ODataVirtualCollectionView.
        */
        lazyLoadGroup(item: wijmo.collections.CollectionViewGroup): void;
        /**
