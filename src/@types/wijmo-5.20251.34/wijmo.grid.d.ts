...
declare module wijmo.grid {
    ...
    class RowCol<T = any> {
         ...
         *
         * Note: When part of a line-wrapped text is enclosed in double quotes (""), a limitation will occur.
         * When you copy and paste the value, it will be split across multiple cells instead of remaining in a single cell.
         *
         * The default value for this property is **false**.
         */
        multiLine: boolean;
