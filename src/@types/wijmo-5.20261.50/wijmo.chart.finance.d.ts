...
declare module wijmo.chart.finance {
    class _BaseRangePlotter extends wijmo.chart._BasePlotter {
        ...
        clear(): void;
        unload(): void;
        adjustLimits(_dataInfo: wijmo.chart._DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        plotSeries(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, series: FinancialSeries, _palette: wijmo.chart._IPalette, _iser: number, _nser: number): void;
        _drawSymbol(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, si: number, _pi: number, w: number, x: number, start: number, end: number, dpt: wijmo.chart._DataPoint): void;
        _getDataPoint(seriesIndex: number, pointIndex: number, series: wijmo.chart.SeriesBase, dataY: number): wijmo.chart._DataPoint;
        _init(): void;
        _calculate(_series: FinancialSeries): void;
...
declare module wijmo.chart.finance {
    ...
    class _PointAndFigurePlotter extends wijmo.chart._BasePlotter {
        ...
        _init(): void;
        adjustLimits(_dataInfo: wijmo.chart._DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        plotSeries(engine: wijmo.chart.IRenderEngine, _ax: wijmo.chart._IAxis, _ay: wijmo.chart._IAxis, _series: FinancialSeries, _palette: wijmo.chart._IPalette, _iser: number, _nser: number): void;
        private calcBoxSize;
        private calcPFHiLo2;
        private roundUp;
        private roundDown;
...
declare module wijmo.chart.finance {
    class _HeikinAshiPlotter extends wijmo.chart._FinancePlotter {
        ...
        clear(): void;
        plotSeries(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, series: FinancialSeries, _palette: wijmo.chart._IPalette, _iser: number, _nser: number): void;
        _drawSymbolWithDpt(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, si: number, pi: number, _fill: any, w: number, x: number, hi: number, lo: number, open: number, close: number, dpt?: wijmo.chart._DataPoint, dt?: wijmo.DataType, pointsLength?: number): void;
