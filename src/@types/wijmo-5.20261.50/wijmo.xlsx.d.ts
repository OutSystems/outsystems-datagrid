...
declare module wijmo.xlsx {
    const unknownFontMaxDigitWidthMap: {};
    function registerMaxDigitWidth(fontFamily: string, fontSize: number, maxDigitWidth: number): void;
    const MaxDigitWidthMap: {
        8: {
            'Gill Sans MT': number;
            Abadi: number;
            'Abadi Extra Light': number;
            'Agency FB': number;
            Aharoni: number;
            Aldhabi: number;
            Algerian: number;
            ...
            AngsanaUPC: number;
            Aparajita: number;
            'Arabic Typesetting': number;
            Arial: number;
            'Arial Black': number;
            'Arial Narrow': number;
            'Arial Nova': number;
            'Arial Nova Cond': number;
            'Arial Nova Cond Light': number;
            'Arial Nova Light': number;
            'Arial Rounded MT Bold': number;
            'Baskerville Old Face': number;
            Batang: number;
            BatangChe: number;
            'Bauhaus 93': number;
            'Bell MT': number;
            Bembo: number;
            'Berlin Sans FB': number;
            'Berlin Sans FB Demi': number;
            'Bernard MT Condensed': number;
            'Blackadder ITC': number;
            'Bodoni MT': number;
            'Bodoni MT Black': number;
            'Bodoni MT Condensed': number;
            'Bodoni MT Poster Compressed': number;
            'Book Antiqua': number;
            'Bookman Old Style': number;
            'Bookshelf Symbol 7': number;
            'Bradley Hand ITC': number;
            'Britannic Bold': number;
            Broadway: number;
            'Browallia New': number;
            BrowalliaUPC: number;
            'Brush Script MT': number;
            Calibri: number;
            'Calibri Light': number;
            'Californian FB': number;
            'Calisto MT': number;
            Cambria: number;
            'Cambria Math': number;
            Candara: number;
            ...
            Centaur: number;
            Century: number;
            'Century Gothic': number;
            'Century Schoolbook': number;
            Chiller: number;
            'Colonna MT': number;
            ...
            Constantia: number;
            'Cooper Black': number;
            'Copperplate Gothic Bold': number;
            'Copperplate Gothic Light': number;
            Corbel: number;
            'Cordia New': number;
            CordiaUPC: number;
            'Courier New': number;
            ...
            'Dubai Medium': number;
            Ebrima: number;
            'Edwardian Script ITC': number;
            Elephant: number;
            'Engravers MT': number;
            'Eras Bold ITC': number;
            'Eras Demi ITC': number;
            'Eras Light ITC': number;
            'Eras Medium ITC': number;
            EucrosiaUPC: number;
            Euphemia: number;
            'Expo M': number;
            FangSong: number;
            'Felix Titling': number;
            'Footlight MT Light': number;
            Forte: number;
            'Franklin Gothic Book': number;
            'Franklin Gothic Demi': number;
            'Franklin Gothic Demi Cond': number;
            'Franklin Gothic Heavy': number;
            'Franklin Gothic Medium': number;
            'Franklin Gothic Medium Cond': number;
            FrankRuehl: number;
            FreesiaUPC: number;
            'Freestyle Script': number;
            'French Script MT': number;
            Gabriola: number;
            Gadugi: number;
            Garamond: number;
            Gautami: number;
            Georgia: number;
            'Georgia Pro': number;
            'Georgia Pro Black': number;
            'Georgia Pro Cond': number;
            'Georgia Pro Cond Black': number;
            'Georgia Pro Cond Light': number;
            'Georgia Pro Cond Semibold': number;
            'Georgia Pro Light': number;
            'Georgia Pro Semibold': number;
            Gigi: number;
            'Gill Sans MT Condensed': number;
            'Gill Sans MT Ext Condensed Bold': number;
            'Gill Sans Nova': number;
            'Gill Sans Nova Cond': number;
            'Gill Sans Nova Cond Lt': number;
            'Gill Sans Nova Cond Ultra Bold': number;
            'Gill Sans Nova Cond XBd': number;
            'Gill Sans Nova Light': number;
            'Gill Sans Nova Ultra Bold': number;
            'Gill Sans Ultra Bold': number;
            'Gill Sans Ultra Bold Condensed': number;
            Gisha: number;
            'Gloucester MT Extra Condensed': number;
            'Goudy Old Style': number;
            'Goudy Stout': number;
            Grotesque: number;
            'Grotesque Light': number;
            Gulim: number;
            GulimChe: number;
            Gungsuh: number;
            GungsuhChe: number;
            'Hadassah Friedlaender': number;
            Haettenschweiler: number;
            'Harlow Solid Italic': number;
            Harrington: number;
            'Headline R': number;
            HGGothicE: number;
            HGGothicM: number;
            HGGyoshotai: number;
            HGKyokashotai: number;
            HGMaruGothicMPRO: number;
            HGMinchoB: number;
            HGMinchoE: number;
            HGPGothicE: number;
            HGPGothicM: number;
            HGPGyoshotai: number;
            HGPKyokashotai: number;
            HGPMinchoB: number;
            HGPMinchoE: number;
            HGPSoeiKakugothicUB: number;
            HGPSoeiKakupoptai: number;
            HGPSoeiPresenceEB: number;
            HGSeikaishotaiPRO: number;
            HGSGothicE: number;
            HGSGothicM: number;
            HGSGyoshotai: number;
            HGSKyokashotai: number;
            HGSMinchoB: number;
            HGSMinchoE: number;
            HGSoeiKakugothicUB: number;
            HGSoeiKakupoptai: number;
            HGSoeiPresenceEB: number;
            HGSSoeiKakugothicUB: number;
            HGSSoeiKakupoptai: number;
            HGSSoeiPresenceEB: number;
            'High Tower Text': number;
            'HYGothic-Extra': number;
            'HYGothic-Medium': number;
            'HYGraphic-Medium': number;
            'HYGungSo-Bold': number;
            'HYHeadLine-Medium': number;
            'HYMyeongJo-Extra': number;
            'HYPMokGak-Bold': number;
            'HYPost-Light': number;
            'HYPost-Medium': number;
            'HYShortSamul-Medium': number;
            'HYSinMyeongJo-Medium': number;
            Impact: number;
            'Imprint MT Shadow': number;
            'Informal Roman': number;
            'Ink Free': number;
            IrisUPC: number;
            'Iskoola Pota': number;
            JasmineUPC: number;
            'Javanese Text': number;
            Jokerman: number;
            'Juice ITC': number;
            KaiTi: number;
            Kalinga: number;
            ...
            Kokila: number;
            'Kristen ITC': number;
            'Kunstler Script': number;
            'Lao UI': number;
            Latha: number;
            Leelawadee: number;
            'Leelawadee UI': number;
            'Leelawadee UI Semilight': number;
            'Levenim MT': number;
            LilyUPC: number;
            'Lucida Bright': number;
            'Lucida Calligraphy': number;
            'Lucida Console': number;
            'Lucida Fax': number;
            'Lucida Handwriting': number;
            'Lucida Sans': number;
            'Lucida Sans Typewriter': number;
            'Lucida Sans Unicode': number;
            'Magic R': number;
            Magneto: number;
            'Maiandra GD': number;
            'Malgun Gothic': number;
            'Malgun Gothic Semilight': number;
            Mangal: number;
            Marlett: number;
            'Matura MT Script Capitals': number;
            Meiryo: number;
            'Meiryo UI': number;
            'Microsoft GothicNeo': number;
            'Microsoft Himalaya': number;
            'Microsoft JhengHei': number;
            'Microsoft JhengHei Light': number;
            'Microsoft JhengHei UI': number;
            'Microsoft JhengHei UI Light': number;
            'Microsoft New Tai Lue': number;
            'Microsoft PhagsPa': number;
            'Microsoft Sans Serif': number;
            'Microsoft Tai Le': number;
            'Microsoft Uighur': number;
            'Microsoft YaHei Light': number;
            'Microsoft YaHei UI': number;
            'Microsoft YaHei UI Light': number;
            'Microsoft Yi Baiti': number;
            MingLiU: number;
            MingLiU_HKSCS: number;
            'MingLiU_HKSCS-ExtB': number;
            'MingLiU-ExtB': number;
            Miriam: number;
            'Miriam Fixed': number;
            Mistral: number;
            'Modern No. 20': number;
            'MoeumT R': number;
            'Mongolian Baiti': number;
            'Monotype Corsiva': number;
            MoolBoran: number;
            'MS Gothic': number;
            'MS Mincho': number;
            'MS Outlook': number;
            'MS PGothic': number;
            'MS PMincho': number;
            'MS Reference Sans Serif': number;
            'MS Reference Specialty': number;
            'MS UI Gothic': number;
            'MT Extra': number;
            'MV Boli': number;
            'Myanmar Text': number;
            Narkisim: number;
            'Neue Haas Grotesk Text Pro': number;
            'New Gulim': number;
            'News Gothic MT': number;
            'Niagara Engraved': number;
            'Niagara Solid': number;
            'Nirmala UI': number;
            'Nirmala UI Semilight': number;
            Nyala: number;
            'OCR A Extended': number;
            OCRB: number;
            'Old English Text MT': number;
            Onyx: number;
            'Palace Script MT': number;
            'Palatino Linotype': number;
            Papyrus: number;
            Parchment: number;
            Perpetua: number;
            'Perpetua Titling MT': number;
            'Plantagenet Cherokee': number;
            Playbill: number;
            PMingLiU: number;
            'PMingLiU-ExtB': number;
            'Poor Richard': number;
            Pristina: number;
            'Pyunji R': number;
            Raavi: number;
            ...
            Ravie: number;
            Rockwell: number;
            'Rockwell Condensed': number;
            'Rockwell Extra Bold': number;
            'Rockwell Light': number;
            'Rockwell Nova': number;
            'Rockwell Nova Cond': number;
            'Rockwell Nova Cond Light': number;
            'Rockwell Nova Extra Bold': number;
            'Rockwell Nova Light': number;
            Rod: number;
            'Sakkal Majalla': number;
            'Sanskrit Text': number;
            'Script MT Bold': number;
            'Segoe MDL2 Assets': number;
            'Segoe Print': number;
            'Segoe Script': number;
            'Segoe UI': number;
            'Segoe UI Black': number;
            'Segoe UI Emoji': number;
            'Segoe UI Historic': number;
            'Segoe UI Light': number;
            'Segoe UI Semibold': number;
            'Segoe UI Semilight': number;
            'Segoe UI Symbol': number;
            Selawik: number;
            'Selawik Light': number;
            'Selawik Semibold': number;
            'Shonar Bangla': number;
            'Showcard Gothic': number;
            Shruti: number;
            'Simplified Arabic': number;
            'Simplified Arabic Fixed': number;
            'SimSun-ExtB': number;
            'Sitka Banner': number;
            'Sitka Display': number;
            'Sitka Heading': number;
            'Sitka Small': number;
            'Sitka Subheading': number;
            'Sitka Text': number;
            'Snap ITC': number;
            'Source Sans Pro': number;
            'Source Sans Pro Black': number;
            'Source Sans Pro ExtraLight': number;
            'Source Sans Pro Light': number;
            'Source Sans Pro SemiBold': number;
            Stencil: number;
            Sylfaen: number;
            Symbol: number;
            Tahoma: number;
            'Tempus Sans ITC': number;
            'TH SarabunPSK': number;
            'Times New Roman': number;
            'Traditional Arabic': number;
            'Trebuchet MS': number;
            Tunga: number;
            'Tw Cen MT': number;
            'Tw Cen MT Condensed': number;
            'Tw Cen MT Condensed Extra Bold': number;
            'UD Digi Kyokasho N-B': number;
            'UD Digi Kyokasho NK-B': number;
            'UD Digi Kyokasho NK-R': number;
            'UD Digi Kyokasho NP-B': number;
            'UD Digi Kyokasho NP-R': number;
            'UD Digi Kyokasho N-R': number;
            Univers: number;
            'Univers Condensed': number;
            'Univers Condensed Light': number;
            'Univers Light': number;
            'Urdu Typesetting': number;
            Utsaah: number;
            Vani: number;
            Verdana: number;
            'Verdana Pro': number;
            'Verdana Pro Black': number;
            'Verdana Pro Cond': number;
            'Verdana Pro Cond Black': number;
            'Verdana Pro Cond Light': number;
            'Verdana Pro Cond SemiBold': number;
            'Verdana Pro Light': number;
            'Verdana Pro SemiBold': number;
            Vijaya: number;
            'Viner Hand ITC': number;
            Vivaldi: number;
            'Vladimir Script': number;
            Vrinda: number;
            Webdings: number;
            'Wide Latin': number;
            Wingdings: number;
            ...
            'Yet R': number;
            'Yu Gothic': number;
            'Yu Gothic Light': number;
            'Yu Gothic Medium': number;
            'Yu Gothic UI': number;
            'Yu Gothic UI Light': number;
            'Yu Gothic UI Semibold': number;
            'Yu Gothic UI Semilight': number;
            'Yu Mincho': number;
            'Yu Mincho Demibold': number;
            'Yu Mincho Light': number;
            仿宋: number;
            华文中宋: number;
            华文仿宋: number;
            华文宋体: number;
    ...
    class WijmoColumnWidthHelper {
        static maxDigitWidth: number;
        static pixelToPoint(pixel: number): number;
        static pointToPixel(point: number, precision?: number): number;
        static setMaxDigitWidth(font: string): number;
        static defaultColumnWidthToPixel(width: number): number;
        static columnWidthToPixel(width: number): number;
        static pixelToColumnWidth(pixelWidth: number): number;
    }
}
declare module wijmo.xlsx {
    /**
    ...
    class Workbook implements IWorkbook {
        ...
        modified: Date;
        /**
         * Gets or sets the title of the xlsx file that appears in the file properties.
         */
        title: string;
        /**
         * Gets or sets the subject of the xlsx file that appears in the file properties.
         */
        subject: string;
        /**
         * Gets or sets the keywords associated with the xlsx file that appear in the file properties.
         */
        keywords: string;
        /**
         * Gets or sets the category of the xlsx file that appears in the file properties.
         */
        category: string;
        /**
    ...
    interface IWorkbook {
        ...
        modified?: Date;
        /**
         * Title of the xlsx file that appears in the file properties.
         */
        title?: string;
        /**
         * Subject of the xlsx file that appears in the file properties.
         */
        subject?: string;
        /**
         * Keywords associated with the xlsx file that appear in the file properties.
         */
        keywords?: string;
        /**
         * Category of the xlsx file that appears in the file properties.
         */
        category?: string;
        /**
...
declare module wijmo.xlsx {
    ...
    class _xlsx {
        ...
        private static _totalRowFunctions;
        ...
        private static getFontForMaxDigitWidth;
        ...
        private static _populateTableTotalRows;
        private static _calculateSubtotal;
        ...
        private static _getSharedStyle;
