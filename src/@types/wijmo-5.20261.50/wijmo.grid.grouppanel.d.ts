...
declare module wijmo.grid.grouppanel {
    ...
    class GroupPanel<T = any> extends wijmo.Control {
        ...
        /**
         * Gets or sets the aria-label attribute of {@link GroupPanel} element.
         *
        ...
        _moveGroup(_marker: HTMLElement, e: MouseEvent): void;
        ...
        _draggingColumn(_s: wijmo.grid.FlexGrid, e: wijmo.grid.CellRangeEventArgs): void;
        _itemsSourceChanging(_s: wijmo.grid.FlexGrid, _e: wijmo.EventArgs): void;
        _itemsSourceChanged(_s: wijmo.grid.FlexGrid, _e: wijmo.EventArgs): void;
        _collectionChanged(_sender: any, e: wijmo.collections.NotifyCollectionChangedEventArgs): void;
