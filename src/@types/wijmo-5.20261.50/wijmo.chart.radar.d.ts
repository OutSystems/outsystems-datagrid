...
declare module wijmo.chart.radar {
    ...
    class _RadarLinePlotter extends wijmo.chart._LinePlotter {
        ...
        plotSeries(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, series: wijmo.chart._ISeries, palette: wijmo.chart._IPalette, _iser: number, _nser: number): void;
...
declare module wijmo.chart.radar {
    ...
    class _RadarBarPlotter extends wijmo.chart._BarPlotter {
        adjustLimits(dataInfo: wijmo.chart._DataInfo, _plotRect: wijmo.Rect): wijmo.Rect;
        _getLabelPoint(series: any, dataPoint: wijmo.chart._DataPoint): wijmo.Point;
        plotSeries(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, series: wijmo.chart._ISeries, _palette: wijmo.chart._IPalette, iser: number, _nser: number): void;
    }
}
declare module wijmo.chart.radar {
    /**
...
declare module wijmo.chart.radar {
    ...
    class FlexRadarAxis extends wijmo.chart.Axis {
        ...
        _updateActualLimitsByChartType(_labels: any, min: any, max: any): {
            min: any;
            max: any;
        };
        _isOverlapped(_engine: wijmo.chart.IRenderEngine, _w: number, _lblClass: string, _axisType: wijmo.chart.AxisType): boolean;
        /**
        ...
        _renderMinors(engine: wijmo.chart.IRenderEngine, ticks: number[], _isVert: boolean, _isNear: boolean): void;
