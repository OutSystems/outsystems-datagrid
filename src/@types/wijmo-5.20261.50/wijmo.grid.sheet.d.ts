...
declare module wijmo.grid.sheet {
    const FlexSheetClsNames: {
        flexSheetFormulaDescription: string;
        flexSheetFormulaList: string;
        flexSheetFormulaName: string;
        headerRow: string;
        hostElement: string;
        tabHolder: string;
    };
    const SheetClsNames: {
        ...
        newSheet: string;
        sheetIcon: string;
        sheetNameEditor: string;
        sheetPage: string;
        sheetTab: string;
    };
    const _ContextMenuClsNames: {
        contextMenuItem: string;
        contextMenuItemSelected: string;
        flexSheetContextMenu: string;
        hostElement: string;
    };
    const _SmartTagClsNames: {
        flexSheetFillMenu: string;
        hostElement: string;
    };
}
declare module wijmo.grid.sheet {
...
declare module wijmo.grid.sheet {
    ...
    class FlexSheet extends wijmo.grid.FlexGrid {
        static _EDITOR_PADDING_BELOW: number;
        static _EDITOR_PADDING_ABOVE: number;
        static _MIN_DIALOG_GAP: number;
        ...
        _getRangesToResize(e: MouseEvent, isAutoSizing?: boolean, _selections?: wijmo.grid.CellRange[]): wijmo.grid.CellRange[] | null;
        private _checkSelectedRangesForResizingCol;
        private _checkSelectedRangesForResizingRow;
        private _removeNegativeRange;
    }
    /**
...
declare module wijmo.grid.sheet {
    class _ContextMenu extends wijmo.Control {
        ...
        protected _handleMenuItemOperation(_menuItems: NodeListOf<Element>): void;
...
declare module wijmo.grid.sheet {
    ...
    class _Expression {
        ...
        evaluatedValue: any;
        evaluate(_rowIndex: number, _columnIndex: number, _sheet?: Sheet, _strictStringCmp?: boolean, _criteriaMode?: boolean, throwOnError?: boolean): any;
        ...
        _refersTo(_rng: wijmo.grid.CellRange): boolean;
        _updateCellRangeExp(_sheetIndex: number, _index: number, _count: number, _isAdding: boolean, _isRow: boolean, _affectRange?: wijmo.grid.CellRange): boolean;
        _moveCellRangeExp(_sheetIndex: number, _srcRange: wijmo.grid.CellRange, _dstRange: wijmo.grid.CellRange, _isChangePos?: boolean, _isCopying?: boolean): boolean;
        _updateCellRangeExpForReorderingRows(_rowDiff: number): boolean;
        _updateCellBoundary(_row: number, _col: number): boolean;
    ...
    class _UnaryExpression extends _Expression {
        ...
        evaluate(rowIndex: number, columnIndex: number, sheet?: Sheet, _strictStringCmp?: boolean, _criteriaMode?: boolean, throwOnError?: boolean): any;
