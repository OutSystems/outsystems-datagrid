...
declare module wijmo.grid.multirow {
    ...
    class _MultiRow extends wijmo.grid.Row {
        _idxRecord: number;
        /**
         * Gets the {@link MultiRow} that owns this row.
         */
        readonly grid: MultiRow;
        /**
...
declare module wijmo.grid.multirow {
     ...
     */
    class _MultiRowEditHandler extends wijmo.grid._EditHandler {
        _selectionChanging(e: wijmo.grid.CellRangeEventArgs): void;
    }
}
declare module wijmo.grid.multirow {
    /**
...
declare module wijmo.grid.multirow {
    ...
    class MultiRow extends wijmo.grid.FlexGrid {
        ...
        _rowHdrCnt: number;
        _toDimensionCheck: any;
        static _ctrlTemplate: string;
        /**
         * Gets or sets the template used to instantiate {@link MultiRow} control.
         */
        ...
        _addNode(items: any[], index: number, _level: number): void;
        ...
        private _refreshHeaderLayoutDefinition;
        private _refreshLayoutDefinition;
        private _updateRecordIndexInFooter;
        _cloneLayoutDefinition(definition: any[]): any[];
        /**
