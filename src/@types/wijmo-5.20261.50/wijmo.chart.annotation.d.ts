...
declare module wijmo.chart.annotation {
    ...
    class AnnotationBase {
        ...
        _getCSSClass(): string;
        _render(_engine: wijmo.chart.IRenderEngine): void;
        _repaint(): void;
        ...
        _getSize(_engine?: wijmo.chart.IRenderEngine): wijmo.Size;
    ...
    class Shape extends AnnotationBase {
        ...
        _renderShape(_engine: wijmo.chart.IRenderEngine): void;
