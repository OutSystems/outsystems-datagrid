...
declare module wijmo.grid.transposedmultirow {
    const TransposedMultiRowClsNames: {
        groupEnd: string;
        groupHeader: string;
        groupStart: string;
        hostElement: string;
...
declare module wijmo.grid.transposedmultirow {
    ...
    class _CellGroup extends _Cell {
        ...
        getBindingColumn(_p: wijmo.grid.GridPanel, r: number, c: number): wijmo.grid.Column;
...
declare module wijmo.grid.transposedmultirow {
    ...
    class TransposedMultiRow<T = any> extends wijmo.grid.FlexGrid {
        ...
        /**
         * Gets or sets the template used to instantiate {@link TransposedMultiRow} control.
         */
