...
declare module wijmo.chart.hierarchical {
    class HierarchicalUtil {
        ...
        static parseFlatItem(data: any, _item: any, _binding: any, _bindingName: any): void;
    }
}
declare module wijmo.chart.hierarchical {
    const SunburstClsNames: {
        hostElement: string;
        slice: string;
        sliceLevel: string;
    };
    const TreeMapClsNames: {
        hostElement: string;
        item: string;
        itemDepth: string;
    };
...
declare module wijmo.chart.hierarchical {
    ...
    class TreeMap extends wijmo.chart.FlexChartBase {
        ...
        _prepareRender(): void;
        _renderChart(engine: wijmo.chart.IRenderEngine, rect: wijmo.Rect, _applyElement: boolean): void;
        ...
        _renderLegend(engine: wijmo.chart.IRenderEngine, pos: wijmo.Point, areas: any[], isVertical: boolean, _width: number, _height: number): void;
...
declare module wijmo.chart.hierarchical {
    ...
    class Sunburst extends wijmo.chart.FlexPie {
        ...
        _renderPie(engine: wijmo.chart.IRenderEngine, _i: number, radius: number, innerRadius: number, startAngle: number, offset: number): void;
