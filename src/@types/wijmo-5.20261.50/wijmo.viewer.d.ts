...
declare module wijmo.viewer {
    class _MultiSelectEx {
        ...
        onCheckedItemsChanged(_sender: any, e: any): void;
        isEditable: boolean;
        isDisabled: boolean;
...
declare module wijmo.viewer {
    const ViewerBaseClsNames: {
        ...
        exportFormatsFooter: string;
        exportFormatsGroup: string;
        exportFormatsWrapper: string;
        footer: string;
        headers: string;
        hostElement: string;
        inputZoom: string;
        ...
        pageCount: string;
        pageNumber: string;
        pageSetupContainer: string;
        pageSetupFooter: string;
        pageThumbnail: string;
        pageViewContinuous: string;
        pageViewPagesContainer: string;
        pageViewSingle: string;
        pageViewVScroller: string;
        pagesWrapper: string;
        pageview: string;
        parameterContainer: string;
        parameterControl: string;
        parameterErrorshidden: string;
        parameterHead: string;
        ...
        searchbtnGroups: string;
        separator: string;
        splitter: string;
        tabContent: string;
        tabContentInner: string;
        ...
        vScrollerWrapper: string;
        viewPage: string;
        viewPanelContainer: string;
...
declare module wijmo.viewer {
    ...
    class _TouchTrigger {
        ...
        _onTouchEvent(_sender: any, e: _TouchEventArgs): void;
...
declare module wijmo.viewer {
    class _DocumentService implements _IDocumentService {
        ...
        getStatus(): IPromise;
        setPageSettings(_pageSettings: _IPageSettings): IPromise;
        getBookmark(_name: string): IPromise;
        executeCustomAction(_action: _IDocAction): IPromise;
        load(_data?: any): IPromise;
        dispose(): IPromise;
        getOutlines(): IPromise;
        renderToFilter(_options: _IRenderOptions): IPromise;
        search(_searchOptions: _ISearchOptions): IPromise;
        getRenderToFilterUrl(_options: _IRenderOptions): IPromise;
        getExportedUrl(_options: _IRenderOptions): IPromise;
...
declare module wijmo.viewer {
    class _DocumentSource {
        ...
        getStatus(): IPromise;
        _createDocumentService(_options: _IDocumentService): _DocumentService;
...
declare module wijmo.viewer {
    class _ReportSourceBase extends _DocumentSource {
        ...
        status: string;
        getParameters(): IPromise;
        setParameters(_parameters: Object): IPromise;
        render(): IPromise;
        executeCustomAction(action: _IDocAction): IPromise;
...
declare module wijmo.viewer {
    class _PageViewBase extends wijmo.Control implements _IPageView {
        ...
        _getAbovePageCount(_top: number): number;
        private _zoom;
        ...
        _render(_pageIndex: number): IPromise;
        _moveToPagePosition(_position: _IDocumentPosition): void;
        ...
        refresh(fullUpdate?: boolean): void;
        isPageContentLoaded(pageIndex: number): boolean;
        protected _hitTestPageIndex(_top: number): number;
        protected _pointInViewPanelClientArea(_clientX: number, _clientY: number): boolean;
        protected _panelViewPntToPageView(_clientX: number, _clientY: number): _IPageHitTestInfo;
    }
}
declare module wijmo.viewer {
...
declare module wijmo.viewer {
    class _MouseTool extends wijmo.Control {
        ...
        protected _start(_ht: _IHitTestInfo): void;
        protected _move(_pnt: wijmo.Point, _ht: _IHitTestInfo): void;
        protected _stop(_pnt?: wijmo.Point): void;
...
declare module wijmo.viewer {
    class _Rubberband extends _MouseTool {
        ...
        protected _move(pnt: wijmo.Point): void;
...
declare module wijmo.viewer {
    ...
    class PdfViewer extends ViewerBase {
        static _ctrlTemplate: string;
        /**
         * Gets or sets the template used to instantiate {@link PdfViewer} control.
         */
        static controlTemplate: string;
        /**
...
declare module wijmo.viewer {
    ...
    class _ArReportSource extends _ReportSourceBase {
        ...
        print(_rotations?: _RotateAngle[]): void;
...
declare module wijmo.viewer {
    ...
    class ReportViewer extends ViewerBase {
        ...
        static _ctrlTemplate: string;
        /**
         * Gets or sets the template used to instantiate {@link ReportViewer} control.
         */
        static controlTemplate: string;
        /**
