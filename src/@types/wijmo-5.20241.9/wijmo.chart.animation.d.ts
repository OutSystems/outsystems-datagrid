...
import { Event, EventArgs } from '@mescius/wijmo';
import { FlexChartBase } from '@mescius/wijmo.chart';
import * as mFinancial from '@mescius/wijmo.chart.finance';
import * as mRadar from '@mescius/wijmo.chart.radar';
import * as selfModule from '@mescius/wijmo.chart.animation';
