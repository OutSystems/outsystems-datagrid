...
import { EventArgs, Event, Control, IEventHandler, Point, Rect } from '@mescius/wijmo';
import { Popup, Menu } from '@mescius/wijmo.input';
import * as selfModule from '@mescius/wijmo.viewer';
