...
import { Rect, DataType } from '@mescius/wijmo';
import { _FinancePlotter, IRenderEngine, _IAxis, _IPalette, SeriesBase, _DataPoint, _DataInfo, _BasePlotter, FlexChartCore, _IPlotter, ChartType } from '@mescius/wijmo.chart';
/**
