...
import { Rect, Size } from '@mescius/wijmo';
import { SeriesBase, _HitTester, IRenderEngine, _IHitArea, FlexChartCore, _BarPlotter, _RectArea, _ISeries, _IAxis, Series } from '@mescius/wijmo.chart';
/**
