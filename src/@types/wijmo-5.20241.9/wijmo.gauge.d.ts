...
import { PropertyChangedEventArgs, Event, Control, Point, Rect, EventArgs, ObservableArray, Size } from '@mescius/wijmo';
import * as selfModule from '@mescius/wijmo.gauge';
/**
