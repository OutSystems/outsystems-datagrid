...
import { Point, Size, Rect, DataType, Event, EventArgs, ICollectionView, ObservableArray, Control, Tooltip, CancelEventArgs } from '@mescius/wijmo';
import * as selfModule from '@mescius/wijmo.chart';
