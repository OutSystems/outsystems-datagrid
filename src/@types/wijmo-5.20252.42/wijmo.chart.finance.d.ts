...
declare module wijmo.chart.finance {
    class _HeikinAshiPlotter extends wijmo.chart._FinancePlotter {
        ...
        clear(): void;
        plotSeries(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, series: FinancialSeries, palette: wijmo.chart._IPalette, iser: number, nser: number): void;
        _drawSymbolWithDpt(engine: wijmo.chart.IRenderEngine, ax: wijmo.chart._IAxis, ay: wijmo.chart._IAxis, si: number, pi: number, fill: any, w: number, x: number, hi: number, lo: number, open: number, close: number, dpt?: wijmo.chart._DataPoint, dt?: wijmo.DataType, pointsLength?: number): void;
