...
declare module wijmo.grid.search {
    ...
    class FlexGridSearch<T = any> extends wijmo.Control {
        ...
        /**
         * Gets or sets the property to determine whether to submit the value in the OnChange event of the input
         */
        isSubmitOnChange: boolean;
        /**
         * Gets or sets the aria-labelledby attribute of {@link FlexGridSearch} input element.
         */
